...
export function VehicleReportWidget() {
  ...
  const complaintCount: number = report?.complaintCount ?? -1;
  ...
  return (
    <div className="w-full">
      {/* ── VIN Form ─────────────────────────────────────────────────────── */}
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto mb-10 relative">
