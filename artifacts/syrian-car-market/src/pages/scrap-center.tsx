    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <div className="relative w-full h-52 bg-gradient-to-br from-orange-700 via-orange-600 to-amber-500 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 items-end">
          <button onClick={() => window.history.length > 1 ? window.history.back() : navigate("/scrap-centers")} className="w-9 h-9 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/30">
