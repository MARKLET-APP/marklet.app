...
export default function SearchPage() {
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <label className="text-sm font-bold text-foreground">طريقة الدفع</label>
        <div className="flex gap-2">
    ...
    <div className="py-8 px-4 flex gap-8">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="mb-6 text-muted-foreground font-medium">
          {isLoading ? "جاري البحث..." : `تم العثور على ${data?.total || 0} سيارة`}
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center bg-card rounded-2xl border border-dashed">
            ...
            <Button variant="outline" onClick={() => setFilters({brand:"", minYear:"", maxYear:"", minPrice:"", maxPrice:"", city:"", saleType:""})} className="mt-6 rounded-xl">
              مسح الفلاتر
            </Button>
          </div>
        ) : (
