...
export default function Favorites() {
  ...
  // Safe to only enable if user exists
    ...
    <div className="py-8 px-4 max-w-7xl mx-auto w-full min-h-[60vh]">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">السيارات التي قمت بحفظها</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center bg-card rounded-3xl border border-dashed shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-2">لا يوجد سيارات في المفضلة</h3>
          <p className="text-muted-foreground max-w-md">قم باستكشاف السوق وأضف السيارات التي تعجبك إلى المفضلة للرجوع إليها لاحقاً بكل سهولة.</p>
        </div>
      ) : (
