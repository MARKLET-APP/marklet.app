    ...
    <div className="home-page flex flex-col w-full overflow-hidden">
      ...
      <section className="py-10 max-w-7xl mx-auto px-4 w-full">
        <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-3xl p-8 text-center border border-primary/10">
          <h2 className="text-2xl font-bold mb-1">{isRTL ? "تابع LAZEMNI" : "Follow LAZEMNI"}</h2>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {/* Facebook */}
            <a href="https://www.facebook.com/profile.php?id=61577551426729" target="_blank" rel="noopener noreferrer"
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/lazemni_official/" target="_blank" rel="noopener noreferrer"
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@lazemni_official?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer"
