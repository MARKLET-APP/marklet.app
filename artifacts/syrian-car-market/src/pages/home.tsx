...
export default function Home() {
  ...
  const categories = [
    ...
    { id: 'rent', name: isRTL ? 'سيارات للإيجار' : 'Cars for Rent', icon: 'key', href: '/search?saleType=rental' },
      ...
      <section className="py-10 max-w-7xl mx-auto px-4 w-full">
        <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-3xl p-8 text-center border border-primary/10">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="https://facebook.com/marklet.sy" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://instagram.com/marklet.sy" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://wa.me/channel/marklet" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://t.me/marklet_sy" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#229ED9] text-white font-bold text-sm hover:opacity-90 transition-opacity">
